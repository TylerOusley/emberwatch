...
The inventory HUD and minimap stay visible. Season, weather and event chips now sit with the day/night clock, while the optional first-watch guide starts collapsed. Pickaxe and chopping actions use the approved, locally hosted recordings; source licenses are available from Settings & help → Sound credits.

Night survival grants are **1,000 gold × the completed night**, without the former 5,000-gold cap: surviving night 10 adds 10,000 to the treasury. Zombie kill and positive-damage assist rewards are **100 for ordinary enemies, 200 for armored zombies and Brood husks, and 1,000 for Gravebreaker bosses**. Each contributor still gets the whole bounty once, including damage from their towers and troops, with no nightly cap.

Workers assigned to an owned mine can choose **All mine resources**, gathering whichever mineral is available while keeping actual resource types in their cargo. Workers and transporters can deliver to other residents' plots as donations. They can only withdraw stock or mine from their owner's plots; a destination ownership change requires reassignment. Existing storage limits, wages and offline-owner behavior continue to apply.

Use **Village menu → Settings & help → Bugs & ideas** to send a bug report or update idea and see its saved review status. The administrator has a private review inbox, filters, notes and export. Ten open reports trigger a review-batch indicator; review and bundled updates remain a human decision. See [the feedback workflow](docs/FEEDBACK.md).
...
Build 29 introduced immediate 100-gold bounties; Build 31 replaces that flat amount with enemy-specific 100/200/1,000-gold rewards. Any positive damage counts, regardless of role, including damage from owned towers and guards while their owner is offline. Each player receives one full bounty per zombie, with no nightly cap or treasury funding requirement. Normal loan repayments apply. The pack tracks kills, assists and gross bounty gold for the current village run.
...
Build 23 removed the steward's fixed 40/80/120-unit merchant export limits; the Build 30 hotfix expands the same policy to all six Resource Exchange materials. Council policies now sell 25% (Conserve), 50% (Balanced, the default), or 100% (Trade) of surplus wheat, timber, stone, iron, coal and sulfur at each visit. Food and repair reserves are protected before calculating the percentage, and sales round down to whole units. Conserve retains its larger reserve. Existing villages keep their selected policy; the council and merchant screens show its percentage.
...
Build 20 added Quick Sell for carried raw resources, visit-stable merchant stock, rear carriage storage-chest animation and E-to-close, worker route recovery, a 5,000-gold nightly treasury award cap (removed in Build 31) and a 1,000-gold outstanding personal-loan cap.
...
| Zombie bounties | Every role earns 100 gold for ordinary enemies, 200 for armored zombies/Brood husks, or 1,000 for Gravebreaker bosses per kill or positive-damage assist, including owned towers and troops. One full payment per contributing player per zombie; paid immediately, with no nightly cap. Normal loan repayments apply. |
...
The traveling merchant visits on day 3 and every second morning after that, staying for the day. Each visit selects two limited specialist wares from iron, coal, and arrows and discounts them 20–30 percent. The steward never imports wheat, timber, or stone. After setting aside food and repair reserves, it exports all six Resource Exchange materials (wheat, timber, stone, iron, coal and sulfur): 25% of each surplus under Conserve, 50% under Balanced, or 100% under Trade, rounded down to whole units without a fixed unit cap. Conserve also doubles the usual reserves. Exports earn one treasury gold per wheat, two per timber, stone, coal or sulfur, and three per iron. Iron, coal and sulfur have no additional reserve; under Trade their entire public exchange stock is exported. Player inventories, private plot storage and civic depots are not exported. An empty stable may be restocked when affordable. Night-survival grants go directly to the treasury rather than the player reward feed: 1,000 gold after night 1, 2,000 after night 2, and 1,000 more for each subsequent night, with no gameplay cap (night 10 pays 10,000 gold). The reward uses the village's completed night number, including in existing runs, and is independent of player count.
...
Visit the treasury to hire up to five personal workers per resident for 75 wallet gold each (Managers start with eight and can train up to ten). Open **Workers** from the treasury or your inventory to choose wheat, timber, stone, iron, coal or sulfur, or **All mine resources** on an owned mine. Choose public resources or your matching production plot as the source. Workers can deliver to your buildings, donate to another resident’s building, or sell at the Resource Exchange. Transporters can likewise donate to another plot; source stock remains owner-only. Deliveries stop if the destination changes owners until you review and reassign that route.

A new worker gathers one unit per harvest on public or level 1 sites, two on level 2 sites, and three on level 3 sites, before seasonal/event bonuses. Each harvest initially takes four seconds; the worker travels between the actual resource and destination and carries up to 40 weight. Tools are included in the contract. Pay is one owner-wallet gold per 30 seconds of work, prepaid in small installments; wages never charge bank savings or purchase credit. Optional tool replacement is separate and uses bank savings. Workers work day and night while anyone is online in their village, including while their employer is offline and near enemies. They finish prepaid time and stop when the owner cannot fund the next wage. Manual pause calls them home; an empty village freezes all crews without spending wages. Returning and waiting for resources, storage, or affordable sales do not incur wages.
