...
function showMenu(){
 ...
 ${state?.emberWardStatus?.equipped?'<div class="panel-row"><span>Heart of Emberwatch<br><small>50 shield for nearby allies · Once each night · Q</small></span><button id="activate-ward" '+(state.emberWardStatus.available?'':'disabled')+'>Ember Ward</button></div>':''}
...
function showBuildStatus(){
 ...
 openPanel(`<div class="village-menu"><header class="village-menu-heading"><div><p class="eyebrow">FIRST LIGHT · BUILD 29</p><h2>A village worth building together.</h2><p>New callings, communal defenses, deeper mines and a full tavern games collection.</p></div><span>${buildingArt('arcane_academy')}</span></header><div class="build-feature-grid">
 ...
 ${feature(itemArt('pickaxe'),'Manager & equipped crews','Managers lead eight personal workers, train up to ten, and pay one gold per sixty seconds worked. Supply real stone or iron tools for 25% or 50% more output. Repair them yourself or budget maintenance from a chosen store. Funded crews still work while any resident is online.')}
 ...
 </div><p class="build-feature-note">Your bank and permanent crate unlocks survive between villages. Role lessons and shared projects belong to this village run.</p></div>`,'village-menu');
}
