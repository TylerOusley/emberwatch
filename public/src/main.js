...
function showBuildStatus(){
 ...
 openPanel(`<div class="village-menu"><header class="village-menu-heading"><div><p class="eyebrow">FIRST LIGHT · BUILD 28</p><h2>A village worth building together.</h2><p>New callings, communal defenses, deeper mines and a full tavern games collection.</p></div><span>${buildingArt('arcane_academy')}</span></header><div class="build-feature-grid">
