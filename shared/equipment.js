...
// Staff ownership is independent of the wear tracked for ordinary tools.
export function ownsStaff(player) { return player?.staffOwned === true; }
...
export function canEquip(player, item) {
  ...
  if (item === 'staff') return player.role === 'wizard' && ownsStaff(player);
