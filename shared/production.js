...
export const PRODUCTION_LEVELS = Object.freeze({
  1: Object.freeze({ level: 1, yieldBonus: 0, nodeMultiplier: 1, nodeHarvests: Object.freeze({ wheat: 1, timber: 5, stone: 8, iron: 8, coal: 8 }), regrowMultiplier: 1, storageCapacity: STORAGE_CAPACITY, healthMultiplier: 1, resourceScale: 1 }),
  2: Object.freeze({ level: 2, yieldBonus: 1, nodeMultiplier: 1.5, nodeHarvests: Object.freeze({ wheat: 2, timber: 8, stone: 12, iron: 12, coal: 12 }), regrowMultiplier: .75, storageCapacity: 2000, healthMultiplier: 1.5, resourceScale: 1.08 }),
  3: Object.freeze({ level: 3, yieldBonus: 2, nodeMultiplier: 2, nodeHarvests: Object.freeze({ wheat: 3, timber: 10, stone: 16, iron: 16, coal: 16 }), regrowMultiplier: .5, storageCapacity: 3000, healthMultiplier: 2, resourceScale: 1.16 })
});
...
export function productionRegrowSeconds(type, plot = null) {
  return (type === 'wheat' ? 90 : 150) * (plot ? .65 : 1) * productionStats(plot).regrowMultiplier;
}
